...
import { EmailSender } from "../services/implementations/email.service";
...
Router.get("/users", authentification, authorization(["admin"]), (req, res) =>
...
Router.post("/forgotPassword", (req, res) =>
  userController.generateRecoveryToken(req, res)
);
